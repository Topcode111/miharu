...
?>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="./managegatelist.css?<?php echo TODAY?>">
		...
		<script type="text/javascript" src="./managegatelist.js?<?php echo TODAY?>"></script>

	</head>
	<body onload="init994(<?php echo  $uuidd;?>)">
